...
CMacOSKeyboardAPI::createEventTapForKeyboard(CGEventTapCallBack         callbackEventTap,
                                             CKeyboardListenerMacOSImpl*  Listener) {
...
// ########################## runRunLoop
void CMacOSKeyboardAPI::runRunLoop() {
  ::CFRunLoopRun();
}
...
// ########################## getUnicodeStringFromMainRunLoop
UniCharCount CMacOSKeyboardAPI::getUnicodeString(CGEventRef Event, UniChar* UnicodeString) {
  UniCharCount ActualStringLength;
  ::CGEventKeyboardGetUnicodeString(Event, kMaxStringLength, &ActualStringLength, UnicodeString);
  return ActualStringLength;
}

// ########################## getUnicodeStringFromMainRunLoop
UniCharCount CMacOSKeyboardAPI::getUnicodeStringFromMainRunLoop(
...
// ########################## isMainRunLoop
bool CMacOSKeyboardAPI::isMainRunLoop() {
