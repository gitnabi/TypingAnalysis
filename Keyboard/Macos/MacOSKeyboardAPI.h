...
class CKeyboardListenerMacOSImpl;
class CShifterInfo;
...
// ----------------------------------------------------------------------------
  ...
  static CFMachPortRef createEventTapForKeyboard(CGEventTapCallBack, CKeyboardListenerMacOSImpl*);
  ...
  static UniCharCount getUnicodeString(CGEventRef, UniChar*);
  static UniCharCount getUnicodeStringFromMainRunLoop(const UCKeyboardLayout*, CVKCode, UInt32*, UniChar[]);
